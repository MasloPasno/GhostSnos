import os
os.system("cls")
os.system("title ИСПОЛЬЗУЙТЕ ПО НАЗНАЧЕНИЮ")
import smtplib
...
⠀⠀⠀                                                                                                                     
      ...
      ..............     .....:::::::::::::-===--:::::::--:::::::::::::===-:..................      
                ...
                ┌──────────────────────────────────────────────────────────────────────┐
                     Сделано Account Deleted    Цена 5$ (ВЕРСИЯ ПРО)            
               └──────────────────────────────────────────────────────────────────────┘
...
def menu():
    ...
    choice = input(f' {RED}   {BLUE}  Выберай >{BLUE} ')
    return choice
...
def main():
    ...
    choice = menu()
    if choice == '1':
        print(f" {PURPLE}[{RED}1{PURPLE}]{BLUE} ==> СНОСИНГ")
        print(f" {PURPLE}[{RED}2{PURPLE}]{BLUE} ==> ДОКСUHG")
        print(f" {PURPLE}[{RED}3{PURPLE}]{BLUE} ==> ТРОЛЛЕНГ")
        print(f" {PURPLE}[{RED}4{PURPLE}]{BLUE} ==> СНОС СЕССИЙ")
        print(f" {PURPLE}[{RED}5{PURPLE}]{BLUE} ==> С премкой")
        print(f" {PURPLE}[{RED}6{PURPLE}]{BLUE} ==> С вирт номером")
